...
knitr::kable( head(PEIMAN::exmplData1$pl1), col.names = '', caption = '')
knitr::kable( head(PEIMAN::exmplData1$pl2), col.names = '', caption = '')
```
...
knitr::kable(PEIMAN::exmplData2[1:6,], caption='beatAML dataset samples')
```
